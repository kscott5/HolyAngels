...
namespace HolyAngels.Web.Controllers {
    public partial class FacebookController {
        ...
        public class ActionNamesClass {
            ...
            public readonly string Deauthorize = "Deauthorize";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_FacebookController: HolyAngels.Web.Controllers.FacebookController {
        ...
        public override System.Web.Mvc.ActionResult Deauthorize() {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Deauthorize);
            return callInfo;
        }
