 ...
 */
function jqrte_uploadimage_return(return_message){eval("data="+return_message);
var str=" <img";
str+=' src="'+data.imagepath.value+'"';
str+=' title="'+$("#uploadimage_desc").val()+'"';
str+=' align="'+$("#uploadimage_alignment").val()+'"';
str+=' border="'+$("#uploadimage_border").val()+'"';
str+="/>";
$.jQRTE.htmlHandler(str,$.jQRTE.element);
$.jQRTE.jqp_c()
}function jqrte_uploadfile_return(return_message){eval("data="+return_message);
var str='<a href="'+data.imagepath.value+'"><img';
...
$(document.getElementById(element).contentWindow.document).bind("keyup",function(e){$.jQRTE.saveRange(element)
});
$(document.getElementById(element).contentWindow.document).bind("keydown",function(e){$.jQRTE.saveRange(element)
});
$(document.getElementById(element).contentWindow.document).bind("click",function(e){$.jQRTE.saveRange(element)
});
$(document.getElementById(element).contentWindow.document).bind("focus",function(e){$.jQRTE.saveRange(element)
})
...
if(navigator.userAgent.indexOf("Firefox")!=-1||navigator.userAgent.indexOf("Safari")!=-1){selection=iframe.contentWindow.window.getSelection()
...
if(navigator.userAgent.indexOf("Firefox")!=-1||navigator.userAgent.indexOf("Safari")!=-1){if($.jQRTE.rangeObj){$.jQRTE.selectionObj.removeAllRanges();
...
if(bcon.length>5&&bcon.substr(0,5).toLowerCase()=="<pre>"){bcon=bcon.substr(5);
bcon=bcon.substr(0,bcon.length-6)
}if(navigator.userAgent.indexOf("MSIE")!=-1){$("#html_content").text(bcon)
}else{$("#html_content").val(bcon)
...
specialcharacter();
$("#uploadimageform").jqupload({callback:"jqrte_uploadimage_return"});
$("#uploadimageform").jqupload_form();
$("#uploadfileform").jqupload({callback:"jqrte_uploadfile_return"});
$("#uploadfileform").jqupload_form();
